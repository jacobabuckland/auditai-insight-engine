...
# Install system dependencies and Node.js for Playwright
...
COPY backend_app/common/ ./backend_app/common/
...
# Run the app
CMD ["uvicorn", "backend_app.main:app", "--host", "0.0.0.0", "--port", "10000"]
